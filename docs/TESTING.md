...
| **Outlook Web** (`outlook.office.com`) | 1. Open email containing Melonbooks product link.<br>2. Click link (left click and middle click). | 1. Link is unwrapped from Microsoft Safe Links.<br>2. Opens with `#outlook-vpn-retry` and reloads cleanly. |
