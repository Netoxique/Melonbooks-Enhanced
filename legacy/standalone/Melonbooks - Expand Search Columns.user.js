// ==UserScript==
// @name         Melonbooks - Expand Search Columns
// @namespace    http://tampermonkey.net/
// @version      1.7.2
// @description  Expand Melonbooks search results, set custom column count, and edit layout values from the page
// @match        https://www.melonbooks.co.jp/search/*
// @grant        GM_addStyle
// ==/UserScript==
...
(function () {
    ...
    const STYLE_ELEMENT_ID = 'mb-column-adjuster-dynamic-style';
    const PANEL_ID = 'mb-column-adjuster-panel';
    const BUTTON_ID = 'mb-column-adjuster-button';

    function isResultsPage() {
        return !!document.querySelector('.item-list > ul');
    }
