// ==UserScript==
// @name         Melonbooks - Listing hover
// @namespace    https://example.com/
// @version      1.3.13
// @description  Show .item-meta as an overlay on top of .item-image on Melonbooks listings, with item states, popup info, privilege title, rank badge, and price/cart below the thumbnail.
...
(function () {
  ...
  const STYLE_ID = 'mb-hover-meta-style';
  ...
  function hasVisiblePriceText(price) {
    return hasVisibleText(price);
  }
  ...
  function buildActionRow(meta) {
    ...
    const priceHasText = hasVisiblePriceText(price);
